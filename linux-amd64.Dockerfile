...
RUN mkdir "${APP_DIR}/bin" && \
    curl -fsSL "https://github.com/Whisparr/Whisparr-Eros/releases/download/v${VERSION}/Whisparr.eros-develop.${VERSION}.linux-musl-x64.tar.gz" | tar xzf - -C "${APP_DIR}/bin" --strip-components=1 && \
