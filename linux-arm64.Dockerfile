...
RUN mkdir "${APP_DIR}/bin" && \
    curl -fsSL "https://github.com/Whisparr/Whisparr/releases/download/v${VERSION}/Whisparr.${VERSION}.linux-musl-arm64.tar.gz" | tar xzf - -C "${APP_DIR}/bin" --strip-components=1 && \
